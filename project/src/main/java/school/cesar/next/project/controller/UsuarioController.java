...
public class UsuarioController {
	...
	public @ResponseBody List<Usuario> list(@RequestParam(required = false) final String primeiroNome) {
	...
	@PatchMapping({ "/{id}", "/{id}/" })
	@ResponseStatus(HttpStatus.OK)
	public @ResponseBody Usuario updatePartially(@PathVariable(value = "id") final Long id,
			@Valid @RequestBody Usuario usuario) throws UsuarioEmptyNameExecption, UsuarioNotFoundExecption {
		return this.usuarioService.updatePartially(id, usuario);
	}
